...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token="EquhPsn8LplTsfWtrRG6.Lkg8ohUsFOz1yZrKJtfpHG.FNvuuNnHIlvsnRvx05UYNJ1O7hPI5KOh6rA7oVPQB2k=")
nadya.loginResult()
print "\n=====[Sukses Login]====="
...
#                            Name = summon(op.param2)
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                gs = nadya.getGroup(msg.to)
                nadya.sendText(msg.to,"เห็นแล้วมันงึด")
                msg.contentType = 7
                ...
                gs = nadya.getGroup(msg.to)
                nadya.sendText(msg.to,"เดะปัดเหนี่ยวเลย")
                msg.contentType = 7
                msg.contentMetadata={'STKID': '102',
                                    'STKPKGID': '1',
                                    'STKVER': '100'}
                ...
                gs = nadya.getGroup(msg.to)
                nadya.sendText(msg.to,"ป่าช้าชัดๆ")
                msg.contentType = 7
                ...
                gs = nadya.getGroup(msg.to)
                nadya.sendText(msg.to,"แล้วเจอกันใหม่นะ😭😭")
                msg.contentType = 7
