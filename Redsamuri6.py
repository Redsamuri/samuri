...
cl = LINETCR.LINE() 
cl.login(token="EqGHz3TxhvfIa0ACj1d6.Lkg8ohUsFOz1yZrKJtfpHG.wwd73ONvnGB96MH5bx3oxkWN90ykBFxdAPzW+RdmrmU=")
cl.loginResult()
...
ki4 = LINETCR.LINE() 
ki4.login(token="EqlCJd8ELUvEBwD97My8.wZxjCuYJwwfJnE+TIiu3Qa.ptsqYuZXwrSfCFDa6dNoVRqbfxSl6EEBrMkgVgKvohA=")
ki4.loginResult()

ki5 = LINETCR.LINE() 
ki5.login(token="EqpIEsc8V5CIkvbHYqk3.TAVOkm2wqPizxdXz1JiGmW.K40rS8y4sgAaTwmiAJrLn9C0r3pgPkU5aRSOyKEmVQU=")
ki5.loginResult()

ki6 = LINETCR.LINE() 
ki6.login(token="EqGxCp0X3le8o96beLH6.MC3I4QsKSrV9tmqyKt6jHG.Ntpi1bcHGQGv+E3QE0LrZIHvdSbJfFKhdrf6RPXx4aw=")
ki6.loginResult()
