...
cl = LINETCR.LINE()
cl.login(token="Eo8jH8cTo9QeZZU5NCZ0.v49TfwwrrE1egDz80w4QKa.38OjYj7Ff3DUrkVXepOUoDDdcvszH4tFW130OnbQpXo=")
cl.loginResult()
print "1\n"

ki = LINETCR.LINE()
ki.login(token="EokZ21rajzwIcpnlX3ad.NDTUuoFwHk9Lw62uGnNI3q.7N5iXaAt9VjGotLJFxdSK3EDfCOADwOVEnz95NH1x3k=")
ki.loginResult()
print "2\n"

kk = LINETCR.LINE()
kk.login(token="Eoj4ZYuRngI5mLSn7rE5.SzfTgudgfYCJ2Hp4sPMEvq.0lf9SjZjGclqvCVO9ccOILH1KndGpuDp67AT6Zhu7Zk=")
kk.loginResult()
print "3\n"

kc = LINETCR.LINE()
kc.login(token="Eob7UbIWxz0BngsvxXl0.udjXm+oXWdAsPTVBgX3cWa.OOGbIA910QBaN/KlmugbVqtqiR4E1QxNdG0NQ1rkQww=")
kc.loginResult()
print "4\n"

kr = LINETCR.LINE()
kr.login(token="EoB2c8Et9v2d1VkTXUSd.+EjGmcOL1XSCj/yTns2vBq.UD4r9iDJF2OCLCpGF5kPm+gUTyJoDFUmqirs5nS4Yqs=")
kr.loginResult()
print "5\n"

ks = LINETCR.LINE()
ks.login(token="EoHpCubeEhKUTqkTJ7F3.UAcSMqonILLriuREirzzuW.hCohhPxw2ekGmZvBQVuJzRYZPXK0Y4rmWMtv5H/b3r0=")
ks.loginResult()
print "6\n"

kb = LINETCR.LINE()
kb.login(token="EoFiUZqZhlCR7kszZlXe.cizeQqNnfxR0s20S26siJG.lAwnfVBHqWidKoLH/BetPPkTPvQ4fVeGgnh0iFrtQ5c=")
kb.loginResult()
print "7\n"
	 ...
	 if wait["Ghost"] == True:
		...
		if msg.from_ in admin:
		    G = cl.getGroup(msg.to)
                    ...
                    G.preventJoinByTicket = True
                    kb.updateGroup(G)
                    kb.sendText(msg.to,"Please type 'help' for show the command.")
		else:
		    cl.sendText(msg.to,"Access Denied For You im Sorry")
		...
		try:
		    ...
		    #      cl.sendText(msg.to,"Autoleave nya nonaktif")                                 		          		          
              ...
              if wait["Leave"] == True:    
		          ...
		          kb.sendText(msg.to,"Autoleave nya nonaktif")                    
