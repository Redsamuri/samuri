...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EpglumuLF6c3K8dSPZ50.v49TfwwrrE1egDz80w4QKa.mXizewUw8bolyoV3JHuBloFYtwDc957AWy1ecvN/uVw=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EpgYGxVvlEWmnV3balhd.NDTUuoFwHk9Lw62uGnNI3q.2uTE7ouXLla/Law29i8it1XRJBO6KQF9Nv1Qj4eRsgY=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token="EpKStAfwgmygeUQnZGf5.SzfTgudgfYCJ2Hp4sPMEvq.UcFmBxXEZh/p1KaebRP3aOF1Nn8VXgqjkb20J5AJjPA=")
kk.loginResult()
print "eaaaaaa\n"
...
botMessage ="""????yin yang??*BotCommand*????yin yang??
...
mediaMessage ="""????yin yang??*MediaCommand*????yin yang??
...
groupMessage ="""????yin yang??*GroupCommand*????yin yang??
...
setMessage ="""????yin yang??*KeziaSetting*????yin yang??
...
creatorMessage ="""????yin yang??*CreatorCommand*????yin yang??
...
adminMessage ="""????yin yang??*AdminCommand*????yin yang??
...
helpMessage ="""????yin yang??*KezCommand*????yin yang??
