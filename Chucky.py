...
cl = LINETCR.LINE()
cl.login(token="EorAUZems4yJIPF5T0j0.v49TfwwrrE1egDz80w4QKa.6tDxTOJT1UWH0DmiuAsFdv0AtQ/gNk+auEMUaeGiVF4=")
cl.loginResult()
print "1\n"

ki = LINETCR.LINE()
ki.login(token="EoPfU58OsJVzLhCY1w6d.NDTUuoFwHk9Lw62uGnNI3q.cDcJhK43nHYnp+v7dVs3ewfLJ3sTG4z1TqwBmOUz6zs=")
ki.loginResult()
print "2\n"

kk = LINETCR.LINE()
kk.login(token="Eo0KGTpiENetwnal14O5.SzfTgudgfYCJ2Hp4sPMEvq.iX5m/tMe+Oh+D0kJQGaXvOvdR5LxkSBLCC9X6m8L2gY=")
kk.loginResult()
print "3\n"

kc = LINETCR.LINE()
kc.login(token="EoB3gGQcAL61z10Quz20.udjXm+oXWdAsPTVBgX3cWa.rJKCqnQd4wU5Ho/uxOrVKaB4cbLlwpyouGf7ZvUF2SI=")
kc.loginResult()
print "4\n"

kr = LINETCR.LINE()
kr.login(token="EoeRYfkpHuRhsPLZBoGa.jCrCvL7g56Fi41uuVPsLwG.emhFTx1s0UebvsHwuuFozWWuuZ5xbOQhbHd755L3unY=")
kr.loginResult()
print "5\n"

ks = LINETCR.LINE()
ks.login(token="EoLyv3mHfpcHLSXA5oAd.+EjGmcOL1XSCj/yTns2vBq.4TuhaTotGtNJuAuMY8EbFVLHW9ZzkXym+eATUxGgIso=")
ks.loginResult()
print "6\n"

kb = LINETCR.LINE()
kb.login(token="Eol8WNBqkbkrzMCrTuQ3.UAcSMqonILLriuREirzzuW.JvbwEkDMidrdmeVfyCKAcfDgUt8HX0jL1eStS39ouiY=")
kb.loginResult()
print "7\n"

kj = LINETCR.LINE()
kj.login(token="Eo2OM7EJBZHTdr4C5gie.cizeQqNnfxR0s20S26siJG.UbzrDc59s+VBVR+bywLJF+ozDzxUXxJ+oFJ1bahepJg=")
kj.loginResult()
print "8\n"
