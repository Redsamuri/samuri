...
cl = LINETCR.LINE()
cl.login(token="EofwweCYdV5BjhUxdxN0.v49TfwwrrE1egDz80w4QKa.dFqwzLEmWtAw+CxCCxADSxPAym9cG8Tea5Y8rfCm4xM=")
cl.loginResult()
print "1\n"

ki = LINETCR.LINE()
ki.login(token="Eog8gKhYg3wczrIVfb9d.NDTUuoFwHk9Lw62uGnNI3q.ETZrX8uDXnd1sRSfaaTOVi1X4IwmM4R/1l+8Lfmdy28=")
ki.loginResult()
print "2\n"

kk = LINETCR.LINE()
kk.login(token="EoXzHNplgTwwpzd4ApD5.SzfTgudgfYCJ2Hp4sPMEvq.lcbmvXXy9ZTM7yuchzpTv6VMUgR2zc2zqHN644I1uQY=")
kk.loginResult()
print "3\n"

kc = LINETCR.LINE()
kc.login(token="Eo249HZ8N614PfbU4MH0.udjXm+oXWdAsPTVBgX3cWa.znwqlGQDYLt7pGJR2hfxY+dcCY/ehWDpdVqxH7R7Coo=")
kc.loginResult()
print "4\n"

kr = LINETCR.LINE()
kr.login(token="Eo3BNKSOcptWOpebMfad.+EjGmcOL1XSCj/yTns2vBq.luIAtzW0GD2MMSYE4WRdLTt8CpmLBeUqu0At7VFnASc=")
kr.loginResult()
print "5\n"

ks = LINETCR.LINE()
ks.login(token="EoTviP2SBPjTpazArDf3.UAcSMqonILLriuREirzzuW.042M9ZsWkD96U3l9cDCV6QNRdT6Ltr6BhNzaL/b7F4w=")
ks.loginResult()
print "6\n"

kb = LINETCR.LINE()
kb.login(token="EomBe4SSEcyMhUDWYnRe.cizeQqNnfxR0s20S26siJG.tKD2Nd0EFYKNlmA3ukWeL3/6D5j9xVTjcukkgkrjbzE=")
kb.loginResult()
print "7\n"
